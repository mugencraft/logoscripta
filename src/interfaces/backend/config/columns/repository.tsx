...
import { getArchiveMetadata } from "../accessors/archived";
...
import { controlColumnGroup, getListSelection } from "./common";
import { baseTableFeatures } from "./common";

export const repositoryConfig: TableConfiguration<RepositoryExtended> = {
	columns: [
		controlColumnGroup,
		{
			id: "info",
