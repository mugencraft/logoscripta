...
import type { RepositoryListItemObsidianTheme } from "@/domain/models/github/types";
...
export const getObsidianThemeTable: GetTableConfiguration<
  RepositoryListItemObsidianTheme
> = (actions) => ({
  columns: [
