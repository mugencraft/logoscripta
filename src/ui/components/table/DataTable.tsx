...
export function DataTable<TData, TTableData extends TData = TData>({
  table,
  config,
   ...
   */
  // biome-ignore lint/correctness/useExhaustiveDependencies: table.getFlatHeaders() is not needed
...
const DataTableBody = <TData, TTableData extends TData = TData>({
  table,
  config,
}: DataTableProps<TData, TTableData>) => {
  return (
