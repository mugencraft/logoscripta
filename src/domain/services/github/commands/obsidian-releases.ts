...
import type {
  ProcessableChanges,
  ProcessingSummary,
} from "../../../config/github/obsidian";
import type { ObsidianPluginHandler } from "../handlers/obsidian-plugin";
import type { ObsidianThemeHandler } from "../handlers/obsidian-theme";
