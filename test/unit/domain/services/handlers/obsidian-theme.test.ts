// test/unit/domain/services/handlers/obsidian-theme.test.ts
...
describe("ObsidianThemeHandler", () => {
	...
	describe("handle", () => {
		...
		it("should handle full theme update with correct metadata structure", async () => {
		...
		it("should handle soft update for existing theme", async () => {
		...
		it("should create metadata with correct timestamps", async () => {
